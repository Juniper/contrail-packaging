...
DEBIAN_FRONTEND=noninteractive dpkg -i binutils_*.deb make_*.deb libdpkg-perl_*.deb dpkg-dev_*.deb patch_*.deb
...
pip install --upgrade --no-deps --index-url='' /opt/contrail/python_packages/Fabric-1.7.5.tar.gz
