...
# mirror list
mirror_list="${CODENAME}-main ${CODENAME}-universe \
             ${CODENAME}-updates-main ${CODENAME}-updates-universe \
             ${CODENAME}-security-main ${CODENAME}-security-universe \
             ${CODENAME}-updates-newton"
