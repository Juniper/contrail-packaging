...
class EventManager:
    ...
    def send_database_usage(self):
        ...
        try:
            ...
            db_info.disk_space_used_1k = int(disk_space_used)
            db_info.disk_space_available_1k = int(disk_space_available)
            db_info.analytics_db_size_1k = int(analytics_db_size)
        except ValueError:
