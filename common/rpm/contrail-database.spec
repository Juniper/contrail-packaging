...
install -D -m 755 %{_distropkgdir}/contrail-kafka-database.ini %{buildroot}%{_supervisordir}/contrail-kafka-database.ini
...
%{_supervisordir}/contrail-kafka-database.ini
