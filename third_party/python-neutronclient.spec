...
install -p -D -m 644 dist/python-neutronclient-v1.05.tar.gz %{buildroot}/opt/contrail/api-venv/archive/python-neutronclient-v1.05.tar.gz
...
/opt/contrail/api-venv/archive/python-neutronclient-v1.05.tar.gz
